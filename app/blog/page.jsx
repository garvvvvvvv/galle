...
export default function BlogIndex() {
  return (
    <main className="blog-listing-page" style={{
      ...
      <h1 className="blog-title-main" style={{
      ...
      <div className="blog-list" style={{
        ...
        {blogPosts.map(post => (
          <Link href={`/blog/${post.slug}`} className="blog-card" key={post.slug} style={{
            display: 'flex',
            flexDirection: 'column',
            background: '#fff',
            borderRadius: 16,
            ...
            <img src={post.image} alt={post.title} className="blog-card-img" style={{
              width: '100%',
              height: 220,
              objectFit: 'cover',
            ...
            <div className="blog-card-content" style={{
              ...
              <div className="blog-card-date" style={{ fontSize: '0.95rem', color: '#8B2E2E', fontWeight: 500 }}>{post.date}</div>
              <div className="blog-card-title" style={{ fontSize: '1.3rem', fontWeight: 700, fontFamily: 'Playfair Display, serif' }}>{post.title}</div>
              <div className="blog-card-desc" style={{ fontSize: '1.05rem', color: '#412a1f', fontWeight: 400 }}>{post.desc}</div>
              <span className="blog-card-read" style={{ color: '#A62639', fontWeight: 700, marginTop: '0.5rem', fontSize: '1.05rem' }}>Read More →</span>
            </div>
          </Link>
        ))}
      </div>
