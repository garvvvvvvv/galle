...
export default function ReviewSection() {
  return (
    <section style={{ margin: '2rem 0', padding: '1.5rem', background: '#fff8f2', borderRadius: 12, maxWidth: '1400px', alignContent: 'center', margin: 'auto', textAlign: 'center'  }}>
      <h2 style={{ fontFamily: 'Playfair Display', fontWeight: 600, fontSize: '1.5rem', marginBottom: 16 }}>Customer Reviews</h2>
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 24 }}>
        {reviews.map((r, i) => (
          <div key={i} style={{ background: '#fff', borderRadius: 10, boxShadow: '0 2px 8px rgba(0,0,0,0.07)', padding: 18, minWidth: 220, flex: 1 }}>
